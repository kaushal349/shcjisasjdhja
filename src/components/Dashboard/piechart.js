...
class PieChartDisplay extends React.Component {
  ...
  render() {
    return (
      <div
        class='card text-center mx-auto my-2 shadow-sm'
        style={{ width: `90%` }}
      >
        ...
        <div class='card-body'>
          ...
          <div className='buttons card-text'>
            ...
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(0)}>
              {this.state.datatext[0]}
            </button>
            <button
              className='colorbutton'
              style={{ backgroundColor: '#800080' }}
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(1)}>
              {this.state.datatext[1]}
            </button>{' '}
            <br />
            <button
              className='colorbutton'
            ...
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(2)}>
              {this.state.datatext[2]}
            </button>{' '}
            <br />
            <button
              className='colorbutton'
            ...
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(3)}>
              {this.state.datatext[3]}
            </button>{' '}
            <br />
            <button
              className='colorbutton'
            ...
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(4)}>
              {this.state.datatext[4]}
            </button>{' '}
            <br />
            <button
              className='colorbutton'
            ...
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(5)}>
              {this.state.datatext[5]}
            </button>
            <button
              className='colorbutton'
              style={{ backgroundColor: '#ffa500' }}
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(6)}>
              {this.state.datatext[6]}
            </button>{' '}
            <br />
            <button
              className='colorbutton'
            ...
            ></button>
            <button className='mybutton' onClick={() => this.handleClick(7)}>
              {this.state.datatext[7]}
            </button>
          </div>
        </div>
      </div>
